...
namespace graphred
{
    public class Rectangle: GraphObject
    {
        ...
        public override void Paint(Graphics gr)
        {
            ...
            gr.DrawRectangle(P, Begin.X, Begin.Y, Width, Hight);
            gr.FillRectangle(B, Begin.X + P.Width / 2, Begin.Y + P.Width / 2, Width - P.Width, Hight - P.Width);
        }
        ...
        {
            string str = "R," + Convert.ToString(PenWidth) + ","
